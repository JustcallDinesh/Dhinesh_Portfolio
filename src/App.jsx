...
import DetailedPersonalInfo from "./components/DetailedPersonalInfo/DetailedPersonalInfo";
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/Dhinesh.png" className="w-10 rounded-full" />
              <q>Avoid or just undertake it</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Dhinesh B" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              ...
              <button 
                ...
                className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full border border-gray-700 hover:bg-[#222] transition-colors"
              >
                <ShinyText text="More Details" disabled={false} speed={3} className="custom-class" />
              </button>
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              ...
              handle="d_i_n_e_s_h_b__41"
              status="Online"
              contactText="Contact Me"
              avatarUrl="./assets/Dhinesh.png"
              showUserInfo={true}
              enableTilt={true}
              enableMobileTilt={false}
              onContactClick={() => window.open('https://instagram.com/d_i_n_e_s_h_b__41', '_blank')}
            />
          </div>
        </div>
        {/* tentang */}
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/dinesh7091566641@gmail.com"
                method="POST"
